...
internal interface ILightflowStorageLocations
{
    ...
    string FileOperationHistoryPath { get; }
...
internal sealed record LightflowStorageLocations : ILightflowStorageLocations
{
    ...
    public required string FileOperationHistoryPath { get; init; }
    public string JobRuntimePath => Path.Combine(ApplicationDataDirectory, "jobs-runtime.json");
    public string PremierePairingDirectory => Path.Combine(ApplicationDataDirectory, "premiere-pairing");
        ...
        LightflowStorageLocationOptions? options = null)
    {
        ...
        return new()
        {
            ...
            FileOperationHistoryPath = Path.Combine(applicationData, "file-operation-history.json"),
