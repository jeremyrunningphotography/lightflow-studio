...
This service performs no move/rename candidate matching, metadata or thumbnail scheduling, filesystem watching, recursive indexing, or Browser presentation. Issues #76, #100, #101, and later Browser work own those capabilities.
