...
| Premiere pairing/session and handoff journal | Pairing directory and Catalog journal remain profile-owned; automatic and explicit bridge connection are disabled to avoid the fixed machine endpoint |
