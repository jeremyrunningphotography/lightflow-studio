...
$requiredNoticeMarkers = @("FlyleafLib 3.11.2-lightflow.2", "172300873b19ec6f544337c5be9619c85fe421b0", "Microsoft.Data.Sqlite 8.0.29", "SQLitePCLRaw 2.1.6", "sqlite.org/copyright")
